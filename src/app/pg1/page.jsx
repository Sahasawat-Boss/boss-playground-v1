                    ...
                    <div>
                        {cardsNav.map((card, index) => (
                            <Link key={index} href={card.link}>
                                <div className="text-center max-w-sm w-96 p-4 my-5 rounded-lg text-white bg-[#303030] cursor-pointer hover:shadow-blue-600 hover:shadow-lg transition hover:scale-105 animate-fade-in-up">
