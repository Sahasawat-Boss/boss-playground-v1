...
function ToolTipServ() {
    ...
    return (
        ...
        >
            ...
            {isHovered && (
                <div className="absolute text-black dark:text-white text-[0.95rem] rounded-sm py-4 px-6 mt-2 ml-5 border border-gray-400 bg-white dark:bg-gray-500 w-[430px] shadow-lg transition-opacity duration-300 opacity-100 z-50">
