...
function AboutMe() {
return (
    <div className='flex-col items-center justify-center pt-0 p-10 bg-[#0b0b14] border-y-[1px] border-white'>
        {/*-- Hero Section --*/}
        ...
        {/*-- Hero Section --*/}
        <section className="bg-gray-100 px-10 py-10 animate-fade-in-up">
