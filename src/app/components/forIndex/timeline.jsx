...
const HorizontalTimeline = () => {
    ...
    return (
        <div className="relative w-full overflow-x-clip py-8 pb-4 px-4 bg-gradient-to-b from-gray-50 to-gray-200 dark:from-gray-900 dark:to-gray-800">
            ...
            {/* Timeline Items */}
            <div className="flex justify-center items-center space-x-8 lg:space-x-16 px-8 mb-8">
                {/* Timeline Point 1 */}
                <div className="relative flex flex-col items-center min-w-[265px] px-3 text-center animation-appearLeft">
                    ...
                    <div className="mt-4 bg-white dark:bg-gray-800 py-4 px-8 shadow-lg rounded-lg transform transition-all duration-300 hover:scale-105 hover:shadow-xl">
                        ...
                        <h4 className="text-lg font-semibold mt-2 text-gray-800 dark:text-gray-200">IT Business Analyst</h4>
                        <p className="text-gray-600 dark:text-gray-400 mt-3">Started IT career as a Business Analyst</p>
                    </div>
                </div>

                {/* Timeline Point 2 */}
                <div className="relative flex flex-col items-center min-w-[265px] px-3 text-center animation-appearUp">
                    <div className="w-12 h-12 flex items-center justify-center rounded-full bg-blue-500 text-white text-3xl shadow-lg border-4 border-white dark:border-gray-800 transform transition-all duration-300 hover:scale-125 hover:shadow-blue-400 dark:hover:shadow-blue-600">
                        🖥️
                    </div>
                    <div className="mt-4 bg-white dark:bg-gray-800 py-4 px-8 shadow-lg rounded-lg transform transition-all duration-300 hover:scale-105 hover:shadow-xl">
                        <h3 className="text-lg font-bold text-blue-500 dark:text-blue-400">2024</h3>
                        <h4 className="text-lg font-semibold mt-2 text-gray-800 dark:text-gray-200">Began studying coding</h4>
                        <p className="text-gray-600 dark:text-gray-400 mt-3">Started learning to code and build projects</p>
                    </div>
                </div>

                {/* Timeline Point 3 */}
                <div className="relative flex flex-col items-center min-w-[265px] px-3 text-center animation-appearRight">
                    <div className="w-12 h-12 flex items-center justify-center rounded-full bg-blue-500 text-white text-3xl shadow-lg border-4 border-white dark:border-gray-800 transform transition-all duration-300 hover:scale-125 hover:shadow-blue-400 dark:hover:shadow-blue-600">
                        🚀
                    </div>
                    <div className="mt-4 bg-white dark:bg-gray-800 py-4 px-8 shadow-lg rounded-lg transform transition-all duration-300 hover:scale-105 hover:shadow-xl">
                        <h3 className="text-lg font-bold text-blue-500 dark:text-blue-400">Current</h3>
                        <h4 className="text-lg font-semibold mt-2 text-gray-800 dark:text-gray-200">Becoming Developer</h4>
                        <p className="text-gray-600 dark:text-gray-400 mt-3">Currently transitioning into a developer role</p>
                    </div>
                </div>
            </div>
            ...
            <div className='flex justify-center animation-appearUp'>
                <div className="text-lg w-fit 2-4 text-center bg-white dark:bg-gray-800 py-5 px-6 rounded-lg shadow-lg transform transition-all duration-300 hover:scale-105 hover:shadow-xl">
                    <h2 className="font-semibold text-gray-500 3ark:text-gray-300">Studied Time</h2>
