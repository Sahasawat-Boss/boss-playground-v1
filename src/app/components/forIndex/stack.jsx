    ...
    return (
        ...
        <div className="bg-white dark:bg-black pb-24 px-10 ">
            ...
            <div className="flex gap-5 justify-center items-center animation-appearUp">
                {/* Designer Card */}
                <div className="w-[500px] bg-gray-100 dark:bg-white font-semibold p-8 rounded-xl shadow-lg shadow-[#c0c0c0] dark:shadow-none text-center">
                    ...
                    <p className="text-gray-600">Moqup</p>
                </div>

                {/* Frontend Developer Card */}
                <div className="w-[500px] bg-gray-100 dark:bg-white font-semibold p-8 rounded-xl shadow-lg shadow-[#c0c0c0] dark:shadow-none text-center animation-appearUp">
                    ...
                    <p className="text-gray-600 mb-4">HTML, CSS, JavaScript, React, Next.js </p>
