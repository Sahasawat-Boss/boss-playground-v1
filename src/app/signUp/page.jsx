...
<Container>
    ...
    <div className="hero-content flex-col">
        ...
        <form className="card-body pt-4 pb-4">
            ...
            <input type="text" placeholder="Plese input your name" 
            ...
            <input type="email" placeholder="Plese input your email" 
            className="input input-bordered focus:border-blue-500 focus:ring-2 focus:ring-blue-400"/>
            </div>
            <div className="form-control">
            <label className="label">
            ...
            <input type="password" placeholder="Plese input your password" 
            className="input input-bordered focus:border-blue-500 focus:ring-2 focus:ring-blue-400"/>
            </div>
            <div className="form-control">
            <label className="label">
            ...
            <input type="password" placeholder="Plese re-input your password" 
            className="input input-bordered focus:border-blue-500 focus:ring-2 focus:ring-blue-400"/>
            </div>
